...
import Apple from '../resource/apple.png';
        ...
        <div>
            <div className="login-header">
                <div className="signup-spotify">
                    <svg role="img" viewBox="0 0 78 24" height="56px" class="Svg-sc-6c3c1v-0 jrsLlJ">
            ...
            <div className='signup-body'>
                <div className='the-body'>
                    <p className='login-message'>To continue, login to Spotify.</p>
                    <div>
                    ...
                    <div className='login-form'>
                        <p className='login-message'>Email address or username</p>
                        <input className='login-input' placeholder='Email address or username' />
                        <p className='login-message'>Password</p>
                        <input className='login-input' type='password' placeholder='Password' />
                        <p className='login-message-unbold'>Forgot your password?</p>
                        <div className='row mt-2 mb-4'>
                            <div className='col d-flex'>
                                <input className='login-checkbox' type='checkbox' />
                                <p className='login-message-unbold'>Remember me</p>
                            </div>

                            <div className='col d-flex justify-content-end'>
                                <NavLink
                                    to={`/`}>
                                    <button className='btn green-login'>LOG IN</button>
                                </NavLink>
                            </div>
                        </div>
                    ...
                    <div className='mt-2'>
                        <NavLink
                            to={`/signup`}>
                            <button className='btn google'>SIGN UP FOR SPOTIFY</button>
                        </NavLink>
                    </div>
                </div>
            </div>
