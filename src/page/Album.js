    ...
    <div className="grey display fullscreen content">
      <div className='grey-gradient fullscreen test'>
        ...
        <div className='header d-flex'>
          <img className='playlist-image' src={Music} />
          <div className='info'>
            <p className='type'>ALBUM</p>
            <h1 className='playlist-title'>{album}</h1>
        ...
        <div className='button-box-place d-flex'>
          ...
          <svg role="img" height="32" width="32" viewBox="0 0 24 24" class="Svg-sc-1bi12j5-0 jgfuCe heart">
