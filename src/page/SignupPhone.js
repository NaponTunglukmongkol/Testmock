                ...
                <div className='the-body'>
                    <div className='signup-box'>
                        <div className='d-flex signupbox'>
                            <div className='phoneid signupbox'>
                                <p></p>
                            ...
                            <div className='phone signupbox'>
                                <p className='phone-message'>ป้อนหมายเลขโทรศัพท์</p>
                                <input className='date-input' placeholder='หมายเลขโทรศัพท์' />
                            </div>
                        </div>
                        <div className='next'>
                            <NavLink
                                to={`/signup`}>
                                <button className='btn green-login'>ถัดไป</button>
                            </NavLink>
                        </div>
                    </div>
                </div>
